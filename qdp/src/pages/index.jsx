        ...
        <div className="hero">
          <div className="heroContainer">
            <div className="textContainer">
              <h1 className={clsx("heroTitle")}>
                {i18n.currentLocale === "en" && (
                  <>
                    <span className="bgBlue">Quantum API</span>
                    <br />
                    <span className="bgBlue">Developer Portal</span>
                  </>
                )}
              </h1>
            ...
            <div className="imageContainer">
              <BrowserOnly>
                {() => {
                  const darkImg = useBaseUrl("/img/authDark.png");
                  const lightImg = useBaseUrl("/img/authorization1.png");
